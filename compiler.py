...
print(parse_arith("ADD R1 R2 R3"))
print(parse_arith_im("ADDI R1 R1 31"))
print(parse_arith_im("ADDI R1 R1 0b11111"))
print(parse_br_brz("BR 31"))
print(parse_br_brz("BRZ 0b11111"))
print(parse_stw("STW R1 (R2)"))
print(parse_ldw("LDW R1 (R2)"))

print("Testing Overall")
print(parse_arith("ADD R1 R2 R3"))
print(parse_instr("ADD R1 R2 R3"))